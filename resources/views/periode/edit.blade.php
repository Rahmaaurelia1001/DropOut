...
<div class="da-shell">
    ...
    <main class="da-main">
        {{-- Header --}}
        <div class="da-phead">
            <a href="{{ route('admin.periode.index') }}" class="da-phead-back" title="Kembali">
                <svg width="16" height="16" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2.5"><path d="M15 19l-7-7 7-7"/></svg>
            </a>
            <div>
                <h2 class="da-phead-title">Edit Periode Penilaian</h2>
            </div>
        </div>
            ...
            <form action="{{ route('admin.periode.update', $periode->id_periode) }}" method="POST">
                ...
                <div class="form-card">
                    <div class="form-card-head">
                        ...
                        <div>
                            <div style="font-weight: 800; font-size: 14px;">Konfigurasi Periode</div>
                            <div style="font-size: 11px; color: var(--gray-400);">Ubah rentang waktu dan status operasional sistem</div>
                        </div>
                    </div>
                    ...
                    <div class="form-body">
                        <div class="form-row">
                            <div class="form-group">
                                ...
                                <input type="text" name="tahun_ajaran" class="form-control" value="{{ $periode->tahun_ajaran }}" required autofocus>
                            </div>
                            <div class="form-group">
                                <label class="form-label">Semester</label>
                                <select name="semester" class="form-control" required>
                                    <option value="1" {{ $periode->semester == '1' ? 'selected' : '' }}>1 (Ganjil)</option>
                                    <option value="2" {{ $periode->semester == '2' ? 'selected' : '' }}>2 (Genap)</option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="form-row">
                            <div class="form-group">
                                ...
                                <span class="form-hint">Status 'Aktif' memungkinkan pengisian data penilaian oleh guru/wali kelas</span>
                            </div>
                        </div>
                    </div>
