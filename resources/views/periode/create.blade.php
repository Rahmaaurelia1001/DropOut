...
<div class="da-shell">
    ...
    <main class="da-main">
        ...
        <div class="da-phead">
            ...
            <div>
                <h2 class="da-phead-title">Tambah Periode Baru</h2>
                <p style="font-size:12px; color:var(--gray-400); margin-top:2px">Buka periode penilaian baru untuk sistem SPK</p>
            </div>
        </div>
            ...
            <form action="{{ route('admin.periode.store') }}" method="POST">
                ...
                <div class="form-card">
                    <div class="form-card-head">
                        ...
                        <div>
                            <div style="font-weight: 800; font-size: 14px;">Detail Periode Akademik</div>
                            <div style="font-size: 11px; color: var(--gray-400);">Tentukan rentang waktu aktif penilaian</div>
                        </div>
                    </div>
                    ...
                    <div class="form-body">
                        <div class="form-row">
                            <div class="form-group">
                                ...
                                <input type="text" name="tahun_ajaran" class="form-control" placeholder="Contoh: 2024/2025" required autofocus>
                            </div>
                            <div class="form-group">
                        ...
                        <div class="form-row">
                            <div class="form-group">
                                ...
                                <span class="form-hint">Gunakan 'Aktif' agar wali kelas bisa langsung mengisi data</span>
                            </div>
                        </div>
                    </div>
