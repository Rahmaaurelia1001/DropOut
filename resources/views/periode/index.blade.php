...
<style>
    ...
    *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    /* Badge Status */
    .badge-status { font-size: 10px; font-weight: 800; text-transform: uppercase; padding: 4px 10px; border-radius: 99px; display: inline-flex; align-items: center; gap: 5px; }
    .badge-aktif { color: var(--green-dk); background: var(--green-lt); border: 1px solid var(--green-bd); }
    .badge-aktif::before { content: ''; width: 5px; height: 5px; background: var(--green-dk); border-radius: 50%; }
    .badge-non { color: var(--red); background: var(--red-lt); border: 1px solid var(--red-bd); }
...
<div class="da-shell">
    ...
    <aside class="da-sidebar">
        ...
        <div class="sb-nav">
            ...
            <a href="{{ route('admin.periode.index') }}" class="sb-item active"><svg width="15" height="15" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2"><path d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"/></svg>Periode Penilaian</a>
    ...
    <main class="da-main">
        <div class="da-phead">
            <div>
                <h2 class="da-phead-title">Periode Penilaian</h2>
                <p style="font-size:12px; color:var(--gray-400); margin-top:2px">Kelola jadwal aktif dan status ganjil/genap penilaian</p>
            </div>
            <a href="{{ route('admin.periode.create') }}" class="btn-add">
        ...
        <div class="da-content">
            ...
            <div class="table-card">
                <div class="table-card-head">
                    <span style="font-weight: 800; font-size: 13px;">Riwayat Periode</span>
                    <span style="font-size: 11px; color: var(--gray-400); background: var(--gray-100); padding: 2px 9px; border-radius: 99px;">{{ $periode->count() }} Periode</span>
                </div>
                    ...
                    <table class="spk-table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td style="font-weight:700; color:var(--gray-900)">{{ $p->tahun_ajaran }}</td>
                                <td>
                                    <span style="font-weight: 600; color: var(--gray-700);">Semester {{ $p->semester }}</span>
                                </td>
                                <td>
                                    <div style="font-size: 12px; font-weight: 500; color: var(--gray-500);">
                                        {{ \Carbon\Carbon::parse($p->tanggal_mulai)->translatedFormat('d M Y') }} 
                                        <span style="margin: 0 4px; color: var(--gray-200);">→</span>
