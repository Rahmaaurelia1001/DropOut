...
<style>
    ...
    *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .card-table { background: var(--white); border: 1.5px solid var(--gray-200); border-radius: 24px; overflow: visible; box-shadow: 0 4px 15px rgba(0,0,0,0.02); }
    ...
    td { padding: 16px 20px; font-size: 13.5px; border-bottom: 1px solid var(--gray-100); vertical-align: middle; }
    ...
    .dd-trigger { 
        width: 100%; background: white; border: 1.5px solid var(--gray-200); padding: 10px 14px; border-radius: 12px; 
    ...
    .dd-item { 
        width: 100%; padding: 10px; border-radius: 8px; text-align: left; background: none; border: none;
                        ...
                        <tbody>
                            @forelse($hasil as $index => $item)
                                <tr>
                                    ...
                                    <td style="font-size: 11px; color: var(--gray-500); max-width: 120px;">{{ $item->faktor_dominan ?? '-' }}</td>
                                    ...
                                    <td style="min-width: 220px;">
                                        @if(!empty($item->tindak_lanjut_final))
                                            <div style="background: #ecfdf5; color: #059669; padding: 10px; border-radius: 10px; font-size: 11px; border: 1px solid #10b981; font-weight: 600;">
                                                {{ $item->tindak_lanjut_final }}
                                            </div>
                                        @else
                                            <span style="color: var(--gray-400); font-size: 11px; font-style: italic;">Belum diputuskan</span>
                                        @endif
                                    </td>
                                </tr>
                            @empty
