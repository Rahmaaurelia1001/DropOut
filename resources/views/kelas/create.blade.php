...
<div class="da-shell">
    ...
    <main class="da-main">
        <div class="da-phead">
            ...
            <div>
                <h2 class="da-phead-title">Tambah Data Kelas</h2>
                <p style="font-size:12px; color:var(--gray-400); margin-top:2px;">Daftarkan kelas baru untuk periode tahun ajaran</p>
            </div>
        </div>
            ...
            <form action="{{ route('admin.kelas.store') }}" method="POST">
                ...
                <div class="form-card">
                    <div class="form-card-head">
                        ...
                        <div>
                            <div style="font-weight:800; font-size:14px;">Identitas Kelas</div>
                            <div style="font-size:11px; color:var(--gray-400);">Pilih tingkatan dan huruf kelas, lalu isi tahun ajaran</div>
                        </div>
                    </div>
                    ...
                    <div class="form-body">
                        ...
                        <div class="preview-kelas">
                            <div class="preview-badge" id="previewNama">—</div>
                            <div>
                                <div class="preview-label">Nama kelas yang akan dibuat</div>
                                <div style="font-size:12px; color:#1d4ed8; font-weight:500;">Akan otomatis terbentuk dari pilihan di bawah</div>
                            </div>
                        </div>
                        ...
                        <div class="form-row-3">
                            ...
                            <div class="form-group">
                                ...
                                <select name="level_kelas" id="level_kelas" class="form-control @error('level_kelas') is-error @enderror" onchange="updatePreview()">
                                    ...
                                    @for($i = 1; $i <= 6; $i++)
                                        <option value="{{ $i }}" {{ old('level_kelas') == $i ? 'selected' : '' }}>Kelas {{ $i }}</option>
                                    @endfor
                                </select>
                                @error('level_kelas')
                            ...
                            <div class="form-group">
                                ...
                                <select name="huruf_kelas" id="huruf_kelas" class="form-control @error('huruf_kelas') is-error @enderror" onchange="updatePreview()">
                                    <option value="">-- Pilih --</option>
                                    <option value="A" {{ old('huruf_kelas') === 'A' ? 'selected' : '' }}>A</option>
                                    <option value="B" {{ old('huruf_kelas') === 'B' ? 'selected' : '' }}>B</option>
                                    <option value="C" {{ old('huruf_kelas') === 'C' ? 'selected' : '' }}>C</option>
                                    <option value="D" {{ old('huruf_kelas') === 'D' ? 'selected' : '' }}>D</option>
                                </select>
                                @error('huruf_kelas')
                                    <span class="form-error"><svg width="12" height="12" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2.5"><path d="M12 9v4m0 4h.01M10.29 3.86L1.82 18a2 2 0 001.71 3h16.94a2 2 0 001.71-3L13.71 3.86a2 2 0 00-3.42 0z"/></svg>{{ $message }}</span>
                                @enderror
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="tahun_ajaran" class="form-control @error('tahun_ajaran') is-error @enderror"
                                    placeholder="Contoh: 2024/2025" value="{{ old('tahun_ajaran') }}">
                                @error('tahun_ajaran')
                                    <span class="form-error"><svg width="12" height="12" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2.5"><path d="M12 9v4m0 4h.01M10.29 3.86L1.82 18a2 2 0 001.71 3h16.94a2 2 0 001.71-3L13.71 3.86a2 2 0 00-3.42 0z"/></svg>{{ $message }}</span>
                                @else
