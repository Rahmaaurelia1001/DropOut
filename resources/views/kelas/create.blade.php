    ...
    <main class="da-main">
        ...
        <div class="da-phead">
            ...
            <div>
                ...
                <p style="font-size:12px; color:var(--gray-400); margin-top:2px">Daftarkan kelas baru untuk periode tahun ajaran mendatang</p>
            </div>
        </div>
                ...
                <div class="form-card">
                    <div class="form-card-head">
                        ...
                        <div>
                            ...
                            <div style="font-size: 11px; color: var(--gray-400);">Lengkapi detail nama kelas dan tahun ajaran</div>
                        </div>
                    </div>
