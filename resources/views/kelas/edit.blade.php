...
<div class="da-shell">
    ...
    <main class="da-main">
        {{-- Header --}}
        <div class="da-phead">
            <a href="{{ route('admin.kelas.index') }}" class="da-phead-back" title="Kembali">
                ...
                <div class="form-card">
                    <div class="form-card-head">
                        ...
                        <div>
                            ...
                            <div style="font-size: 11px; color: var(--gray-400);">Perbarui nama kelas dan tahun ajaran</div>
                        </div>
                    </div>
                    ...
                    <div class="form-body">
                        <div class="form-row">
                            <div class="form-group">
                                ...
                                <input type="text" name="nama_kelas" class="form-control" value="{{ $kelas->nama_kelas }}" required placeholder="Misal: Kelas 1A">
                            </div>
                            <div class="form-group">
                                <label class="form-label">Tahun Ajaran</label>
                                <input type="text" name="tahun_ajaran" class="form-control" value="{{ $kelas->tahun_ajaran }}" required placeholder="Misal: 2023/2024">
                            </div>
                        </div>
                    </div>
