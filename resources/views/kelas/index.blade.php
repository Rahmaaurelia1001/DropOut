                    ...
                    <table class="spk-table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td style="font-weight:700; color:var(--gray-900)">{{ $k->nama_kelas }}</td>
                                <td>
                                    <span style="background: var(--blue-lt); color: var(--blue); padding: 4px 10px; border-radius: 6px; font-weight: 600; font-size: 12px;">
                                        {{ $k->tahun_ajaran }}
                                    </span>
                                </td>
                                <td>
