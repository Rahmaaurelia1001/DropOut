...
<style>
    ...
    *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .da-body { padding: 32px; max-width: 1000px; }

    /* ── CARDS ── */
    .card { background: var(--white); border: 1.5px solid var(--gray-200); border-radius: 20px; padding: 24px; box-shadow: 0 4px 15px rgba(0,0,0,0.02); margin-bottom: 24px; }
    .card-title { font-size: 15px; font-weight: 800; color: var(--gray-900); margin-bottom: 20px; display: flex; align-items: center; gap: 10px; }
    ...
    .p-item { padding: 16px; border-radius: 12px; background: var(--gray-50); border: 1px solid var(--gray-100); }
    .p-lbl { font-size: 11px; font-weight: 700; color: var(--gray-400); text-transform: uppercase; margin-bottom: 4px; }
    .p-val { font-size: 16px; font-weight: 800; color: var(--gray-800); }

    /* ── BUTTONS ── */
    .btn-run { 
        background: var(--blue); color: white; padding: 14px 28px; border-radius: 14px; 
        font-weight: 800; font-size: 14px; border: none; cursor: pointer; transition: .2s;
        display: inline-flex; align-items: center; gap: 10px;
    }
    .btn-run:hover { background: #1d4ed8; transform: translateY(-2px); box-shadow: 0 8px 20px rgba(37,99,235,0.2); }

    .alert { padding: 16px 20px; border-radius: 14px; font-size: 13.5px; font-weight: 600; margin-bottom: 24px; border: 1px solid transparent; }
...
<div class="da-shell">
    ...
    <main class="da-main">
        ...
        <div class="da-body">
            ...
            @if($periodeAktif)
                <div class="card">
                    <h3 class="card-title">Periode Penilaian Aktif</h3>
                ...
                <div class="card" style="text-align: center; padding: 48px 24px;">
                    <div style="width: 64px; height: 64px; background: var(--blue-lt); color: var(--blue); border-radius: 50%; display: flex; align-items: center; justify-content: center; margin: 0 auto 20px;">
                    ...
                    <h3 style="font-size:20px; font-weight:800; color:var(--gray-900); margin-bottom:12px;">Mulai Proses Perhitungan</h3>
                    <p style="font-size:14px; color:var(--gray-500); max-width:500px; margin: 0 auto 32px; line-height:1.6;">Sistem akan melakukan kalkulasi Multi-Factor Evaluation Process (MFEP) pada seluruh data siswa di periode ini secara otomatis.</p>
            ...
            @else
                <div class="alert alert-warning" style="display: flex; align-items: center; gap: 12px; padding: 24px;">
                    ...
                    <div>
                        <h4 style="font-size:15px; font-weight:800; margin-bottom:4px;">Periode Tidak Tersedia</h4>
                        <p style="font-weight:500; opacity:0.8;">Saat ini tidak ada periode aktif. Harap hubungi Administrator untuk mengaktifkan periode penilaian.</p>
                    </div>
                </div>
            @endif
        </div>
