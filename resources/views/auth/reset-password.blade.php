...
<style>
    ...
    *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .feat-text { font-size: 13px; color: rgba(255,255,255,0.85); font-weight: 600; }
    ...
    .right-sub { font-size: 13px; color: var(--gray-500); font-weight: 500; }
    ...
    .btn-toggle {
        position: absolute; right: 8px; padding: 8px;
        background: none; border: none; color: var(--gray-400);
        cursor: pointer; display: flex; border-radius: 8px;
    }
    ...
    @media (max-width: 640px) {
        ...
        .login-panel-left { flex: none; padding: 32px 28px; min-height: auto; }
...
<div class="login-card">
    ...
    <div class="login-panel-right">
        ...
        <div class="right-head">
            <h1 class="right-title">Reset Kata Sandi</h1>
            <p class="right-sub">Buat kata sandi baru untuk akun Anda</p>
        </div>
        ...
        <form method="POST" action="{{ route('password.store') }}">
            ...
            <div class="form-group">
                ...
                @error('email')
                    <div class="error-msg">
                        <svg width="13" height="13" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2.5"><circle cx="12" cy="12" r="10"/><path d="M12 8v4m0 4h.01"/></svg>
                        {{ $message }}
                    </div>
                @enderror
            </div>
            ...
            <div class="form-group">
                ...
                <div class="input-wrapper">
                    ...
                    >
                    <button type="button" class="btn-toggle" onclick="togglePw('password', 'ico-eye-1', 'ico-off-1')">
                        <svg id="ico-eye-1" width="17" height="17" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2">
                            <path d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"/>
                            <path d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z"/>
                        </svg>
                        <svg id="ico-off-1" width="17" height="17" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2" style="display:none">
            ...
            <div class="form-group">
                ...
                <div class="input-wrapper">
                    ...
                    >
                    <button type="button" class="btn-toggle" onclick="togglePw('password_confirmation', 'ico-eye-2', 'ico-off-2')">
                        <svg id="ico-eye-2" width="17" height="17" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2">
                            <path d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"/>
                            <path d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z"/>
                        </svg>
                        <svg id="ico-off-2" width="17" height="17" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2" style="display:none">
                            <path d="M13.875 18.825A10.05 10.05 0 0112 19c-4.478 0-8.268-2.943-9.543-7a9.97 9.97 0 011.563-3.029m5.858.908a3 3 0 114.243 4.243M9.878 9.878l4.242 4.242M9.88 9.88l-3.29-3.29m7.532 7.532l3.29 3.29M3 3l3.59 3.59m0 0A9.953 9.953 0 0112 5c4.478 0 8.268 2.943 9.543 7a10.025 10.025 0 01-4.132 5.411m0 0L21 21"/>
                        </svg>
                    </button>
                </div>
...
<script>
function togglePw(inputId, eyeId, offId) {
