...
<div class="da-shell">
    ...
    <main class="da-main">
        {{-- Header --}}
        <div class="da-phead">
            <a href="{{ route('admin.mapel.index') }}" class="da-phead-back" title="Kembali">
                <svg width="16" height="16" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2.5"><path d="M15 19l-7-7 7-7"/></svg>
            </a>
            <div>
                <h2 class="da-phead-title">Tambah Mata Pelajaran</h2>
                <p style="font-size:12px; color:var(--gray-400); margin-top:2px">Daftarkan mata pelajaran baru ke dalam sistem</p>
            </div>
        </div>

        <div class="da-content">
            @if ($errors->any())
                <div style="margin-bottom: 20px; padding: 12px 16px; background: var(--red-lt); border: 1.5px solid var(--red-bd); border-radius: 10px; color: var(--red); font-size: 13px;">
                    <ul style="list-style: inside; font-weight: 600;">
            ...
            <form action="{{ route('admin.mapel.store') }}" method="POST">
                ...
                <div class="form-card">
                    <div class="form-card-head">
                        ...
                        <div>
                            <div style="font-weight: 800; font-size: 14px;">Detail Pelajaran</div>
                            <div style="font-size: 11px; color: var(--gray-400);">Lengkapi nama mata pelajaran di bawah ini</div>
                        </div>
                    </div>
                    ...
                    <div class="form-body">
                        <div class="form-group">
                            ...
                            <input type="text" name="nama_mapel" class="form-control" placeholder="Contoh: Matematika" required autofocus>
                        </div>
                    </div>
