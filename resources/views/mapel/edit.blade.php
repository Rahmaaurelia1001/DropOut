...
<div class="da-shell">
    ...
    <main class="da-main">
        ...
        <div class="da-phead">
            ...
            <div>
                <h2 class="da-phead-title">Edit Mata Pelajaran</h2>
            </div>
        </div>
            ...
            <form action="{{ route('admin.mapel.update', $mapel->id_mapel) }}" method="POST">
                ...
                <div class="form-card">
                    <div class="form-card-head">
                        ...
                        <div>
                            <div style="font-weight: 800; font-size: 14px;">Data Pelajaran</div>
                            <div style="font-size: 11px; color: var(--gray-400);">Ubah nama mata pelajaran yang terdaftar</div>
                        </div>
                    </div>
                    ...
                    <div class="form-body">
                        <div class="form-group">
                            ...
                            <input type="text" name="nama_mapel" class="form-control" value="{{ $mapel->nama_mapel }}" required autofocus>
                        </div>
                    </div>
