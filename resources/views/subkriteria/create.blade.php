...
<div class="da-shell">
    ...
    <main class="da-main">
        {{-- Header --}}
        <div class="da-phead">
            <a href="{{ route('admin.subkriteria.index') }}" class="da-phead-back" title="Kembali">
                <svg width="16" height="16" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2.5"><path d="M15 19l-7-7 7-7"/></svg>
            </a>
            <div>
                <h2 class="da-phead-title">Tambah Subkriteria</h2>
                <p style="font-size:12px; color:var(--gray-400); margin-top:2px">Daftarkan parameter detail untuk kriteria penilaian</p>
            </div>
        </div>
                ...
                <div class="form-card">
                    <div class="form-card-head">
                        <div class="form-card-ico">
                            <svg width="18" height="18" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2"><path d="M4 6h16M4 10h16M4 14h10M4 18h6"/></svg>
                        </div>
                        <div>
                            <div style="font-weight: 800; font-size: 14px;">Detail Subkriteria</div>
                            <div style="font-size: 11px; color: var(--gray-400);">Lengkapi data kriteria induk dan bobot skalanya</div>
                        </div>
                    </div>

                    <div class="form-body">
                        <div class="form-group">
                            <label class="form-label">Pilih Kriteria Induk</label>
                            <select name="id_kriteria" class="form-control" required autofocus>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="nama_subkriteria" class="form-control" 
                                   placeholder="Contoh: Rendah / Menengah / Tinggi" required>
                        </div>

                        <div class="form-group">
                            <label class="form-label">Nilai Skala</label>
                            <input type="number" name="nilai_skala" class="form-control" 
                                   placeholder="Contoh: 1, 2, 3, 4, 5" required>
                            <span class="form-hint">Nilai ini akan dikalikan dengan bobot kriteria utama</span>
                        </div>
                    </div>
