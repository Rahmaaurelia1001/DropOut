...
<div class="da-shell">
    ...
    <main class="da-main">
        ...
        <div class="da-phead">
            ...
            <div>
                <h2 class="da-phead-title">Edit Subkriteria</h2>
            </div>
        </div>
            ...
            <form action="{{ route('admin.subkriteria.update', $subkriteria->id_subkriteria) }}" method="POST">
                ...
                <div class="form-card">
                    <div class="form-card-head">
                        ...
                        <div>
                            <div style="font-weight: 800; font-size: 14px;">Parameter Subkriteria</div>
                            <div style="font-size: 11px; color: var(--gray-400);">Ubah kriteria induk, nama parameter, dan nilai skalanya</div>
                        </div>
                    </div>
                    ...
                    <div class="form-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="nama_subkriteria" class="form-control" 
                                   value="{{ $subkriteria->nama_subkriteria }}" required placeholder="Contoh: Sangat Baik / Rendah">
                        </div>

                        <div class="form-group">
                            <label class="form-label">Nilai Skala</label>
                            <input type="number" name="nilai_skala" class="form-control" 
                                   value="{{ $subkriteria->nilai_skala }}" required placeholder="Contoh: 1, 2, 3, 4, 5">
                            <span class="form-hint">Nilai numerik untuk pembobotan SPK</span>
                        </div>
                    </div>
