...
<div class="da-shell">
    ...
    <main class="da-main">
        ...
        <div class="da-phead">
            ...
            <div>
                <h2 class="da-phead-title">Edit Kriteria</h2>
            </div>
        </div>
            ...
            <form action="{{ route('admin.kriteria.update', $kriteria->id_kriteria) }}" method="POST">
                ...
                <div class="form-card">
                    <div class="form-card-head">
                        ...
                        <div>
                            <div style="font-weight: 800; font-size: 14px;">Detail Kriteria</div>
                            <div style="font-size: 11px; color: var(--gray-400);">Ubah parameter kriteria dan nilai bobotnya</div>
                        </div>
                    </div>
                    ...
                    <div class="form-body">
                        <div class="form-group">
                            ...
                            <input type="text" name="nama_kriteria" class="form-control" value="{{ $kriteria->nama_kriteria }}" required autofocus>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <span class="form-hint">Masukkan nilai antara 0.00 sampai 1.00</span>
                        </div>
                    </div>
