...
<style>
    ...
    *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    /* Stats Card (Weight Info) */
    .weight-card { background: var(--blue); border-radius: 14px; padding: 16px 20px; color: white; display: flex; align-items: center; justify-content: space-between; box-shadow: 0 4px 12px rgba(37,99,235,.2); }
    .weight-label { font-size: 12px; font-weight: 600; opacity: 0.8; text-transform: uppercase; }
    .weight-value { font-size: 20px; font-weight: 800; }
...
<div class="da-shell">
    ...
    <main class="da-main">
        <div class="da-phead">
            <div>
                <h2 class="da-phead-title">Data Kriteria Penilaian</h2>
                <p style="font-size:12px; color:var(--gray-400); margin-top:2px">Tentukan kriteria dan bobot untuk perhitungan SPK</p>
            </div>
            <a href="{{ route('admin.kriteria.create') }}" class="btn-add">
        ...
        <div class="da-content">
            ...
            <div class="weight-card">
                <div>
                    <div class="weight-label">Total Akumulasi Bobot</div>
                    <div style="font-size: 11px; opacity: 0.7; margin-top: 2px;">Batas maksimal bobot adalah 1.00</div>
                </div>
                <div class="weight-value">
                    {{ number_format(\App\Models\Kriteria::sum('bobot'), 2) }} <span style="font-size: 14px; opacity: 0.6;">/ 1.00</span>
                </div>
            </div>

            <div class="table-card">
                <div class="table-card-head">
                    <span style="font-weight: 800; font-size: 13px;">Daftar Kriteria</span>
                    <span style="font-size: 11px; color: var(--gray-400); background: var(--gray-100); padding: 2px 9px; border-radius: 99px;">{{ $kriteria->count() }} Kriteria</span>
                </div>
                    ...
                    <table class="spk-table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <span style="font-weight: 800; color: var(--blue); background: var(--blue-lt); padding: 4px 10px; border-radius: 6px;">
