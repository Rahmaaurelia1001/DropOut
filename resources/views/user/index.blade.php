...
<style>
    ...
    *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .sb-nav-section { 
        ...
        text-transform: uppercase; letter-spacing: 0.1em; padding: 0 8px; margin: 14px 0 5px; 
    }
    ...
    .spk-table td { padding: 13px 20px; font-size: 13px; border-bottom: 1px solid var(--gray-100); }
    
    .badge-aktif { color: var(--green-dk); background: var(--green-lt); border: 1px solid var(--green-bd); padding: 3px 9px; border-radius: 99px; font-size: 10.5px; font-weight: 700; display: inline-flex; align-items: center; gap: 4px; }
    .badge-aktif::before { content: ''; width: 5px; height: 5px; border-radius: 50%; background: var(--green-dk); }
...
<div class="da-shell">
    ...
    {{-- ══ SIDEBAR (FULL MENU & MATCHED FONT) ══ --}}
    <aside class="da-sidebar">
        <div class="sb-brand">
            <div class="sb-logo">
                <svg width="20" height="20" fill="none" stroke="white" viewBox="0 0 24 24" stroke-width="2"><path d="M12 14l9-5-9-5-9 5 9 5z"/><path d="M12 14l6.16-3.422a12.083 12.083 0 01.665 6.479A11.952 11.952 0 0012 20.055a11.952 11.952 0 00-6.824-2.998 12.078 12.078 0 01.665-6.479L12 14z"/></svg>
            </div>
            <div>
        ...
        <div class="sb-nav">
            ...
            <a href="{{ route('admin.user.index') }}" class="sb-item {{ request()->routeIs('admin.user.*') ? 'active' : '' }}">
                <svg width="15" height="15" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2"><path d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0z"/></svg> Manajemen User
            </a>
            <a href="{{ route('admin.kelas.index') }}" class="sb-item {{ request()->routeIs('admin.kelas.*') ? 'active' : '' }}">
                <svg width="15" height="15" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2"><path d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4"/></svg> Data Kelas
            </a>
            <a href="{{ route('admin.siswa.index') }}" class="sb-item {{ request()->routeIs('admin.siswa.*') ? 'active' : '' }}">
                <svg width="15" height="15" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2"><path d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253"/></svg> Data Siswa
            </a>
            <a href="{{ route('admin.mapel.index') }}" class="sb-item {{ request()->routeIs('admin.mapel.*') ? 'active' : '' }}">
                <svg width="15" height="15" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2"><path d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253"/></svg> Mata Pelajaran
            </a>

            <div class="sb-nav-section">SPK</div>
            <a href="{{ route('admin.kriteria.index') }}" class="sb-item {{ request()->routeIs('admin.kriteria.*') ? 'active' : '' }}">
                <svg width="15" height="15" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2"><path d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2"/></svg> Data Kriteria
            </a>
            <a href="{{ route('admin.subkriteria.index') }}" class="sb-item {{ request()->routeIs('admin.subkriteria.*') ? 'active' : '' }}">
                <svg width="15" height="15" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2"><path d="M4 6h16M4 10h16M4 14h10M4 18h6"/></svg> Data Subkriteria
            </a>
            <a href="{{ route('admin.periode.index') }}" class="sb-item {{ request()->routeIs('admin.periode.*') ? 'active' : '' }}">
                <svg width="15" height="15" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2"><path d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"/></svg> Periode Penilaian
            </a>
            <a href="{{ route('admin.master-rekomendasi.index') }}" class="sb-item {{ request()->routeIs('admin.master-rekomendasi.*') ? 'active' : '' }}">
                <svg width="15" height="15" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2"><path d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-6 9l2 2 4-4"/></svg> Rekomendasi
            </a>
        </div>
        ...
        <div class="sb-user">
            ...
            <div style="flex:1; min-width:0">
                <div style="font-weight:700; font-size:12px; overflow:hidden; text-overflow:ellipsis; white-space:nowrap">{{ Auth::user()->name }}</div>
    ...
    <main class="da-main">
        <div class="da-phead">
            <div>
                <h2 class="da-phead-title">Manajemen User</h2>
                <p style="font-size:12px; color:var(--gray-400); margin-top:2px">Kelola daftar administrator, kepala sekolah, dan wali kelas</p>
            </div>
        ...
        <div class="da-content">
            <div class="table-card">
                <div class="table-card-head">
                    <span style="font-weight: 800; font-size: 13px;">Daftar Pengguna Sistem</span>
                    <span style="font-size: 11px; color: var(--gray-400); background: var(--gray-100); padding: 2px 9px; border-radius: 99px;">{{ $user->count() }} user</span>
                </div>
                ...
                <div style="overflow-x:auto;">
                    <table class="spk-table">
                        ...
                        <tbody>
                            @foreach($user as $u)
                            <tr>
                                <td style="font-weight:700; color:var(--gray-400)">{{ $loop->iteration }}</td>
                                <td>
                                    <div style="font-weight:700; color:var(--gray-900)">{{ $u->name }}</div>
