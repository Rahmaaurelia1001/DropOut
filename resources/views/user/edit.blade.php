...
<div class="da-shell">
    ...
    <main class="da-main">
        ...
        <div class="da-phead">
            ...
            <div>
                <h2 class="da-phead-title">Edit Data User</h2>
            </div>
        </div>
            ...
            <form action="{{ route('admin.user.update', $user->id) }}" method="POST">
                ...
                <div class="form-card">
                    <div class="form-card-head">
                        ...
                        <div>
                            <div style="font-weight: 800; font-size: 14px;">Informasi Akun</div>
                            <div style="font-size: 11px; color: var(--gray-400);">Perbarui kredensial dan hak akses pengguna</div>
                        </div>
                    </div>
                    ...
                    <div class="form-body">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group">
                                ...
                                <span class="form-hint text-red">*Hanya untuk Wali Kelas</span>
                            </div>
                        </div>
                        ...
                        <div class="form-row">
                            <div class="form-group">
                                ...
                                <span class="form-hint">Kosongkan jika tidak ingin mengganti password</span>
                            </div>
                            <div class="form-group">
