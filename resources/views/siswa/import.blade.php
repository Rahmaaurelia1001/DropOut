...
<style>
    ...
    *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .form-control {
        ...
        border-radius: 9px; font-size: 13px; font-weight: 500; outline: none; transition: all .15s;
    }
    ...
    input[type="file"]::file-selector-button {
        ...
        border-radius: 6px; font-weight: 600; font-size: 12px; cursor: pointer; margin-right: 12px;
    }

    /* Template Alert */
    .template-info { background: var(--blue-lt); border: 1.5px solid var(--blue-mid); border-radius: 10px; padding: 14px 18px; }
    .template-info h4 { font-size: 13px; font-weight: 800; color: var(--blue); margin-bottom: 8px; }
    .template-info ul { list-style: none; font-size: 12px; color: var(--gray-700); }
    .template-info li { margin-bottom: 4px; display: flex; align-items: center; gap: 8px; }
    .template-info li::before { content: '•'; color: var(--blue); font-weight: bold; }
    ...
    .btn { display: inline-flex; align-items: center; gap: 7px; padding: 9px 18px; border-radius: 9px; font-size: 13px; font-weight: 700; cursor: pointer; text-decoration: none; border: none; transition: all .15s; }
...
<div class="da-shell">
    ...
    <main class="da-main">
        ...
        <div class="da-phead">
            ...
            <div>
                <h2 class="da-phead-title">Import Data Siswa</h2>
            </div>
        </div>

        <div class="da-content">
            @if ($errors->any())
                <div style="margin-bottom: 20px; padding: 14px 20px; background: var(--red-lt); border: 1.5px solid var(--red-bd); border-radius: 12px; color: var(--red); font-size: 13px;">
                    <p style="font-weight: 800; margin-bottom: 5px;">Terjadi kesalahan upload:</p>
                ...
                <div class="form-card">
                    <div class="form-card-head">
                        <div class="form-card-ico">
                            <svg width="18" height="18" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2"><path d="M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-8l-4-4m0 0L8 8m4-4v12"/></svg>
                        </div>
                        <div>
                            <div style="font-weight: 800; font-size: 14px;">Upload File Massal</div>
                            <div style="font-size: 11px; color: var(--gray-400);">Gunakan file format .xls atau .xlsx</div>
                        </div>
                    </div>
