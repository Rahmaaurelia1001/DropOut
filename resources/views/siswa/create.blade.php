...
<div class="da-shell">
    ...
    <main class="da-main">
        ...
        <div class="da-phead">
            ...
            <div>
                <h2 class="da-phead-title">Tambah Siswa Baru</h2>
                <p style="font-size:12px; color:var(--gray-400); margin-top:2px">Daftarkan profil siswa ke dalam basis data sistem</p>
            </div>
        </div>
            ...
            <form action="{{ route('admin.siswa.store') }}" method="POST">
                ...
                <div class="form-card">
                    <div class="form-card-head">
                        ...
                        <div>
                            <div style="font-weight: 800; font-size: 14px;">Identitas Siswa</div>
                            <div style="font-size: 11px; color: var(--gray-400);">Lengkapi data NISN dan biodata dasar</div>
                        </div>
                    </div>
