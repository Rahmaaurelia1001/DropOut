...
<div class="da-shell">
    ...
    <main class="da-main">
        ...
        <div class="da-phead">
            ...
            <div>
                <h2 class="da-phead-title">Edit Profil Siswa</h2>
            </div>
        </div>
            ...
            <form action="{{ route('admin.siswa.update', $siswa->id_siswa) }}" method="POST">
                ...
                <div class="form-card">
                    <div class="form-card-head">
                        ...
                        <div>
                            <div style="font-weight: 800; font-size: 14px;">Biodata Siswa</div>
                            <div style="font-size: 11px; color: var(--gray-400);">Perbarui data NISN, nama, dan penempatan kelas</div>
                        </div>
                    </div>
                    ...
                    <div class="form-body">
                        <div class="form-row">
                            <div class="form-group">
                                ...
                                <input type="text" name="nisn" class="form-control" value="{{ $siswa->nisn }}" required placeholder="Masukkan 10 digit NISN">
                            </div>
                            <div class="form-group">
                                <label class="form-label">Nama Lengkap</label>
                                <input type="text" name="nama_siswa" class="form-control" value="{{ $siswa->nama_siswa }}" required placeholder="Nama lengkap sesuai akta">
                            </div>
                        </div>
