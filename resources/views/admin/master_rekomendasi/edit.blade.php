    ...
    <main class="da-main">
        ...
        <div class="da-phead">
            <div class="da-phead-left">
                ...
                <div>
                    <div class="da-phead-title">Edit Master Rekomendasi</div>
                    <div class="da-phead-sub">Ubah data rekomendasi tindak lanjut yang sudah tersimpan</div>
                </div>
            </div>
        </div>
        ...
        <div class="da-content">
            <form action="{{ route('admin.master-rekomendasi.update', $masterRekomendasi->id_master_rekomendasi) }}" method="POST">
                @csrf
                @method('PUT')
                    ...
                    <div class="form-card-body">
                            ...
                            <div class="form-group">
                                ...
                                <select name="kategori_risiko" class="form-control {{ $errors->has('kategori_risiko') ? 'is-error' : '' }}">
                                    ...
                                    @foreach($kategoriOptions as $k)
                                        <option value="{{ $k }}" {{ old('kategori_risiko', $masterRekomendasi->kategori_risiko) == $k ? 'selected' : '' }}>{{ $k }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group">
                                ...
                                <select name="faktor_dominan" class="form-control {{ $errors->has('faktor_dominan') ? 'is-error' : '' }}">
                                    ...
                                    @foreach($faktorOptions as $f)
                                        <option value="{{ $f }}" {{ old('faktor_dominan', $masterRekomendasi->faktor_dominan) == $f ? 'selected' : '' }}>{{ $f }}</option>
                                    @endforeach
                                </select>
                        ...
                        <div class="form-group full">
                            ...
                            <textarea name="deskripsi_rekomendasi"
                                ...
                                placeholder="Tuliskan deskripsi tindak lanjut yang direkomendasikan...">{{ old('deskripsi_rekomendasi', $masterRekomendasi->deskripsi_rekomendasi) }}</textarea>
                        ...
                        <div class="form-group" style="max-width: 240px;">
                            ...
                            <select name="is_active" class="form-control">
                                <option value="1" {{ old('is_active', $masterRekomendasi->is_active) == '1' ? 'selected' : '' }}>Aktif</option>
                                <option value="0" {{ old('is_active', $masterRekomendasi->is_active) == '0' ? 'selected' : '' }}>Nonaktif</option>
                            </select>
